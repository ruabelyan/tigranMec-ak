                        ...
                        <div className="sidebar-textwidget">
                            <div className="sidebar-info-contents">
                                <div className="content-inner">
                                    <div className="logo">
                                        <Link href="/"><img style={{ height: 60, paddingLeft: 40 }} src="assets/images/logo.png" alt="" /></Link>
                                    </div>
                                    <div className="content-box">
                                        ...
                                        <Link href="about.html" className="theme-btn btn-one"><span>Մեր մասին</span></Link>
                                    </div>
