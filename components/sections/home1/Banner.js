        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-12 col-sm-12 content-column">
            <div className="content-box">
              <span className="upper-text">Ծառայության ամենաբարձր մակարդակը, որը դուք կարող եք գտնել</span>
              <h2>Վերցրեք <span>Հոգատարություն ձեր մասին</span> Health Now.</h2>
              <p>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
              <div className="btn-box">
                <Link href="/#" className="theme-btn btn-two"><span>Բացահայտեք մեր ծառայությունը</span></Link>
              </div>
            </div>
          </div>
